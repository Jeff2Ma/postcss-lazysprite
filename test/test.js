...
describe('postcss-lazysprite Unit Test', function () {
  ...
  describe('Basic Functions', function () {
    ...
    it('Create sprites -> should create correct css content and images files.', function (done) {
      vfs.src('./test/src/css/test.1.css')
        ...
        .pipe(through2.obj(function (file, enc, cb) {
          ...
          let cssExpected = fs.readFileSync(path.resolve(process.cwd(), './test/src/css/test.1.excepted.css'), {encoding: 'utf8'})
          let spritesExists1 = fs.existsSync(path.resolve(process.cwd(), './test/dist/sprites/filetype.png'))
          let spritesExists2 = fs.existsSync(path.resolve(process.cwd(), './test/dist/sprites/filetype@2x.png'))
    ...
    it('Retina support -> should @2x and _2x are all work well.', function (done) {
      vfs.src('./test/src/css/test.2.css')
        ...
        .pipe(through2.obj(function (file, enc, cb) {
          ...
          let cssExpected = fs.readFileSync(path.resolve(process.cwd(), './test/src/css/test.2.excepted.css'), {encoding: 'utf8'})
          let spritesExists1 = fs.existsSync(path.resolve(process.cwd(), './test/dist/sprites/logo@2x.png'))
          let spritesExists2 = fs.existsSync(path.resolve(process.cwd(), './test/dist/sprites/logo@3x.png'))
    ...
    it('Multi `@lazysprite` atRule -> should work with multi `@lazysprite` atRule.', function (done) {
      ...
      let cssExpected = fs.readFileSync(path.resolve(process.cwd(), './test/src/css/test.4.excepted.css'), {encoding: 'utf8'})
  ...
  describe('Options Functions', function () {
    ...
    it('`smartUpdate`  option -> should work well.', function (done) {
      vfs.src('./test/src/css/test.1.css')
        ...
        .pipe(through2.obj(function (file, enc, cb) {
          let content = file.contents.toString()
          let cssExpected = fs.readFileSync(path.resolve(process.cwd(), './test/src/css/test.3.excepted.css'), {encoding: 'utf8'})
          let spritesExists1 = fs.existsSync(path.resolve(process.cwd(), './test/dist/sprites/filetype.cbed5ca6a9.png'))
          let spritesExists2 = fs.existsSync(path.resolve(process.cwd(), './test/dist/sprites/filetype@2x.3f1f178013.png'))
    ...
    it('`retinaInfix` opiton-> should work well.', function (done) {
      vfs.src('./test/src/css/test.7.css')
        ...
        .pipe(through2.obj(function (file, enc, cb) {
          // let content = file.contents.toString();
          let spritesExists1 = fs.existsSync(path.resolve(process.cwd(), './test/dist/sprites/check.png'))
          let spritesExists2 = fs.existsSync(path.resolve(process.cwd(), './test/dist/sprites/check_2x.png'))
          spritesExists1.should.be.ok()
          spritesExists2.should.be.ok()
          cb()
        }))
